...
def main():
    ...
    def collate_fn(examples):
        ...
        print('padded_tokens.input_ids.shape: ', padded_tokens.input_ids.shape)
        batch = {
    ...
    train_dataloader = torch.utils.data.DataLoader(
        train_dataset, shuffle=True, collate_fn=collate_fn, batch_size=args.total_train_batch_size
    )
    ...
    def train_step(params, batch, train_rng):
        ...
        def compute_loss(params):
            vae_outputs = vae_state.apply_fn(batch["pixel_values"], params=params['vae'], dropout_rng=dropout_rng, train=True)
